...
use CommonBundle\Entity\Publisher;
...
class PublisherController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $publishers = $em->getRepository('CommonBundle:Publisher')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CommonBundle\Form\PublisherType', $publisher);
    ...
    {
        $deleteForm = $this->createDeleteForm($publisher);
        $editForm = $this->createForm('CommonBundle\Form\PublisherType', $publisher);

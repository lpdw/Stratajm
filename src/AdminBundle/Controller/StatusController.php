...
use CommonBundle\Entity\Status;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $statuses = $em->getRepository('CommonBundle:Status')->findAll();
    ...
    {
        $status = new Status();
        $form = $this->createForm('CommonBundle\Form\StatusType', $status);
    ...
    {
        $deleteForm = $this->createDeleteForm($status);
        $editForm = $this->createForm('CommonBundle\Form\StatusType', $status);
